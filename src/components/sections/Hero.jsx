      ...
      <StyledHeroContainer ismobile={isMobile}>
        <StyledHeroGrid ismobile={isMobile} container spacing={0}>
          <Grid item style={{ paddingLeft: "0 !important" }}>
            <StyledHeroImage alt="Image of Aswanth CK" src={img} />
          </Grid>
          <StyledHeroText item>
            ...
            Passionate about building scalable, user-friendly web applications. Always exploring new technologies and best practices to improve development processes. And I like motorcycling
            </StyledHeroSubText>
          </StyledHeroText>
        </StyledHeroGrid>
      </StyledHeroContainer>
